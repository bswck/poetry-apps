...
# This script was adopted from https://github.com/bswck/skeleton/tree/ec770f0/project/scripts/bump.sh.jinja
#
# Usage:
# $ poe bump
...
# Automatically copied from https://github.com/bswck/skeleton/tree/ec770f0/handle-task-event.sh
make_token() {
    export TOKEN
