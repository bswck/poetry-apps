...
# This script was adopted from https://github.com/bswck/skeleton/tree/14b9f1e/project/scripts/bump.sh.jinja
#
# Usage:
# $ poe bump
...
# Automatically copied from https://github.com/bswck/skeleton/tree/14b9f1e/handle-task-event.sh
make_token() {
    export TOKEN
